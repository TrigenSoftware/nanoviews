...
Nano Kit is an ecosystem of lightweight, modular, and performant libraries for building modern web applications, built around [a push-pull based reactivity system](https://github.com/stackblitz/alien-signals). Each library is designed to be small and tree-shakeable, while still offering rich DX and useful features.
...
Comparison of bundle sizes for various implementations of the [weather example](https://github.com/TrigenSoftware/nanoviews/tree/main/examples/weather) bundled with Vite:
...
Comparison of bundle sizes for various implementations of the [rick-and-morty example](https://github.com/TrigenSoftware/nanoviews/tree/main/examples/rick-and-morty) bundled with Vite:
